				...
				<div class="inner">
					<nav>
						<ul>
							...
							<li><a href="#one">구매내역</a></li>
							<li><a href="#two">내정보 수정</a></li>
...
=======
				<section id="intro" class="wrapper style1 fullscreen fade-up">
					<div class="inner">
						<h1>마이페이지 환영한다 동무</h1>
						<p>
							이 페이지에서 회원정보를 수정하고, 구매내역을 조회할수 있습니다<br />
						<ul class="actions">
							<li><a href="#one" class="button scrolly">구매내역</a></li>
						</ul>
					</div>
...
>>>>>>> refs/remotes/origin/dev
					...
					<section>
						<a href="#" class="image"><img src="images/OLIVIA.jpg" alt=""
						...
						<div class="content">
							<div class="inner">
								...
								<ul class="actions">
									<li><a href="../user/purchase/purchaseHistory.jsp"
										class="button">구매 내역이동</a></li>
								</ul>
							</div>
						</div>
					</section>
					...
					<div class="inner">
						...
						<div class="features">
							<section>
								...
								<form method="post"
									action="../servlet?controller=user&command=upDate">
									userId :
									<%
...
>>>>>>> refs/remotes/origin/dev
									<ul class="contact">
										<li><a
											href="../servlet?controller=product+review&command=productList"
											class="button">메인페이지 이동</a></li>
									</ul>
								</form>
							</section>
							<section>
...
=======
				</div> <!-- Footer --> <footer id="footer" class="wrapper style1-alt">
					<div class="inner">
						<ul class="menu">
				...
				</footer> <!-- Scripts --> <script src="assets/js/jquery.min.js"></script> <script
