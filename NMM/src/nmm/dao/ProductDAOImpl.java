...
//		}
	...
	public List<ProductDTO> selectJacket() throws Exception {
		...
		String sql = "SELECT PRODUCT_NO,PRODUCT_NAME,PRODUCT_PRICE FROM PRODUCT WHERE PRODUCT_CATEGORY='����'";
		try {
			con = DbUtil.getConnection();
			ps = con.prepareStatement(sql);
			rs = ps.executeQuery();
	...
	public List<ProductDTO> selectCoat() throws Exception {
		...
		ResultSet rs = null;
		List<ProductDTO> list = new ArrayList<ProductDTO>();
		String sql = "SELECT PRODUCT_NO,PRODUCT_NAME,PRODUCT_PRICE FROM PRODUCT WHERE PRODUCT_CATEGORY='��Ʈ'";
		try {
			con = DbUtil.getConnection();
			ps = con.prepareStatement(sql);
			rs = ps.executeQuery();
	...
	public List<ProductDTO> selectPadding() throws Exception {
		...
		ResultSet rs = null;
		List<ProductDTO> list = new ArrayList<ProductDTO>();
		String sql = "SELECT PRODUCT_NO,PRODUCT_NAME,PRODUCT_PRICE FROM PRODUCT WHERE PRODUCT_CATEGORY='�е�'";
		try {
			con = DbUtil.getConnection();
			ps = con.prepareStatement(sql);
			rs = ps.executeQuery();
...
//			DbUtil.dbClose(rs, ps, con);
//		}
//		product = new ProductDTO(productNo, "��Ʈ", 1, "�Ѻ�����Ʈ", "��Ʈ�̹���", "����", "95", "1500");
//		
		return product;
	}
